...
public class ProductsAttributesApi {
  ...
  */
  public List<Attribute> addProductsAttributes (Attribute attribute) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = attribute;
    // verify the required parameter 'attribute' is set
    if (attribute == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'attribute' when calling addProductsAttributes",
        new ApiException(400, "Missing the required parameter 'attribute' when calling addProductsAttributes"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (List<Attribute>) ApiInvoker.deserialize(localVarResponse, "array", Attribute.class);
      } else {
         return null;
      }
   ...
   * @param attribute Attribute to add to the store
  */
  public void addProductsAttributes (Attribute attribute, final Response.Listener<List<Attribute>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = attribute;
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<Attribute>) ApiInvoker.deserialize(localVarResponse,  "array", Attribute.class));
  ...
  * deletes a single attribute of products based on the ID supplied
   ...
   * @return void
  */
  public void deleteProductAttributeById (Long id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling deleteProductAttributeById",
        new ApiException(400, "Missing the required parameter 'id' when calling deleteProductAttributeById"));
    }

    // create path and map variables
    String path = "/attributes/{id}/".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
   ...
   * @param id ID of attribute to delete
  */
  public void deleteProductAttributeById (Long id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/attributes/{id}/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  * Returns a attribute of products based on a single ID  ### Includes You can give the following values on includes parameter: &#x60;options&#x60; 
   ...
   * @return Attribute
  */
  public Attribute getProductAttributeById (Long id, List<String> includes) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getProductAttributeById",
        new ApiException(400, "Missing the required parameter 'id' when calling getProductAttributeById"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (Attribute) ApiInvoker.deserialize(localVarResponse, "", Attribute.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * 
   * Returns a attribute of products based on a single ID  ### Includes You can give the following values on includes parameter: &#x60;options&#x60; 
   * @param id ID of attribute to fetch   * @param includes Include associated objects within response
  */
  public void getProductAttributeById (Long id, List<String> includes, final Response.Listener<Attribute> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((Attribute) ApiInvoker.deserialize(localVarResponse,  "", Attribute.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Returns all attributes of products from the system that the user has access to  ### Includes You can give the following values on includes parameter: &#x60;options&#x60; 
   ...
   * @return List<Attribute>
  */
  public List<Attribute> getProductsAttributes (List<String> includes, Integer limit, List<String> orderBy) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getProductsAttributes (List<String> includes, Integer limit, List<String> orderBy, final Response.Listener<List<Attribute>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * update a single attribute of products based on the ID supplied
   ...
   * @return Attribute
  */
  public Attribute updateProductAttributeById (Long id, Attribute productAttribute) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = productAttribute;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateProductAttributeById",
        new ApiException(400, "Missing the required parameter 'id' when calling updateProductAttributeById"));
    }
    // verify the required parameter 'productAttribute' is set
    if (productAttribute == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'productAttribute' when calling updateProductAttributeById",
        new ApiException(400, "Missing the required parameter 'productAttribute' when calling updateProductAttributeById"));
    }
   ...
   * 
   * update a single attribute of products based on the ID supplied
   * @param id ID of attribute to update   * @param productAttribute Attribute to add to the store
  */
  public void updateProductAttributeById (Long id, Attribute productAttribute, final Response.Listener<Attribute> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = productAttribute;
