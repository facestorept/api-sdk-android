...
public class CategoriesApi {
  ...
  */
  public InlineResponse2011 addCategories (Category category) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = category;
    // verify the required parameter 'category' is set
    if (category == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'category' when calling addCategories",
        new ApiException(400, "Missing the required parameter 'category' when calling addCategories"));
    }
   ...
   * @param category Category to add to the store
  */
  public void addCategories (Category category, final Response.Listener<InlineResponse2011> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = category;
  ...
  * deletes a single category based on the ID supplied
   ...
   * @return void
  */
  public void deleteCategoryById (Long id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling deleteCategoryById",
        new ApiException(400, "Missing the required parameter 'id' when calling deleteCategoryById"));
    }
   ...
   * @param id ID of category to delete
  */
  public void deleteCategoryById (Long id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public InlineResponse2001 getCategories (List<String> includes, Integer limit, List<String> orderBy) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getCategories (List<String> includes, Integer limit, List<String> orderBy, final Response.Listener<InlineResponse2001> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns a category based on a single ID  ### Includes You can give the following values on includes parameter: &#x60;routes, products&#x60; 
   ...
   * @return InlineResponse2011
  */
  public InlineResponse2011 getCategoryById (Long id, List<String> includes, Integer limit) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getCategoryById",
        new ApiException(400, "Missing the required parameter 'id' when calling getCategoryById"));
    }
   ...
   * 
   * Returns a category based on a single ID  ### Includes You can give the following values on includes parameter: &#x60;routes, products&#x60; 
   * @param id ID of category to fetch   * @param includes Include associated objects within response   * @param limit max records to return
  */
  public void getCategoryById (Long id, List<String> includes, Integer limit, final Response.Listener<InlineResponse2011> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * update a single category based on the ID supplied
   ...
   * @return void
  */
  public void updateCategoryById (Long id, Object category) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = category;
    // verify the required parameter 'id' is set
    if (id == null) {
    ...
    // verify the required parameter 'category' is set
    if (category == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'category' when calling updateCategoryById",
        new ApiException(400, "Missing the required parameter 'category' when calling updateCategoryById"));
    }
   ...
   * 
   * update a single category based on the ID supplied
   * @param id ID of category to update   * @param category Category to update in store
  */
  public void updateCategoryById (Long id, Object category, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = category;
