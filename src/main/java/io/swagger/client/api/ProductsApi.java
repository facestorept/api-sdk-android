...
public class ProductsApi {
  ...
  */
  public InlineResponse2014 addProduct (Product product) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = product;
    // verify the required parameter 'product' is set
    if (product == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'product' when calling addProduct",
        new ApiException(400, "Missing the required parameter 'product' when calling addProduct"));
    }
   ...
   * @param product Product to add to the store
  */
  public void addProduct (Product product, final Response.Listener<InlineResponse2014> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = product;
  ...
  * deletes a single product based on the ID supplied
   ...
   * @return void
  */
  public void deleteProductById (Long id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling deleteProductById",
        new ApiException(400, "Missing the required parameter 'id' when calling deleteProductById"));
    }
   ...
   * @param id ID of product to delete
  */
  public void deleteProductById (Long id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns a product based on a single ID  ### Includes You can give the following values on includes parameter: &#x60;brands, categories, routes, stocks&#x60; 
   ...
   * @return InlineResponse2014
  */
  public InlineResponse2014 getProductById (Long id, List<String> includes, Integer limit) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getProductById",
        new ApiException(400, "Missing the required parameter 'id' when calling getProductById"));
    }
   ...
   * 
   * Returns a product based on a single ID  ### Includes You can give the following values on includes parameter: &#x60;brands, categories, routes, stocks&#x60; 
   * @param id ID of product to fetch   * @param includes Include associated objects within response   * @param limit max records to return
  */
  public void getProductById (Long id, List<String> includes, Integer limit, final Response.Listener<InlineResponse2014> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public InlineResponse2006 getProducts (List<String> includes, Integer limit, List<String> orderBy) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getProducts (List<String> includes, Integer limit, List<String> orderBy, final Response.Listener<InlineResponse2006> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * update a single product based on the ID supplied
   ...
   * @return void
  */
  public void updateProductById (Long id, Product tax) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tax;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateProductById",
        new ApiException(400, "Missing the required parameter 'id' when calling updateProductById"));
    }
    // verify the required parameter 'tax' is set
    if (tax == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tax' when calling updateProductById",
        new ApiException(400, "Missing the required parameter 'tax' when calling updateProductById"));
    }
   ...
   * 
   * update a single product based on the ID supplied
   * @param id ID of product to update   * @param tax Product to add to the store
  */
  public void updateProductById (Long id, Product tax, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tax;
  ...
  * update a single product based on the ID supplied
   ...
   * @return void
  */
  public void updateProductById_1 (Long id, Product tax) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tax;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateProductById_1",
        new ApiException(400, "Missing the required parameter 'id' when calling updateProductById_1"));
    }
    // verify the required parameter 'tax' is set
    if (tax == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tax' when calling updateProductById_1",
        new ApiException(400, "Missing the required parameter 'tax' when calling updateProductById_1"));
    }
   ...
   * @param id ID of product to update   * @param tax Product to add to the store
  */
  public void updateProductById_1 (Long id, Product tax, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tax;
