...
public class CustomersApi {
  ...
  */
  public List<Customer> getCustomerById (Long id, List<String> includes) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * 
   * Returns all customers from the system that the user has access to  ### Includes You can give the following values on includes parameter: &#x60;orders, groups&#x60; 
   * @param id ID of customer   * @param includes Include associated objects within response
  */
  public void getCustomerById (Long id, List<String> includes, final Response.Listener<List<Customer>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns all customers from the system that the user has access to  ### Includes You can give the following values on includes parameter: &#x60;orders, groups&#x60; 
   ...
   * @return List<Customer>
  */
  public List<Customer> getCustomers (List<String> includes, Integer limit, List<String> orderBy) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getCustomers (List<String> includes, Integer limit, List<String> orderBy, final Response.Listener<List<Customer>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
