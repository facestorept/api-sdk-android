...
public class ShippingsApi {
  String basePath = "https://api.facestore.local/v1";
  ...
  */
  public InlineResponse2013 addShipping (Shipping shipping) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = shipping;
    // verify the required parameter 'shipping' is set
    if (shipping == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'shipping' when calling addShipping",
        new ApiException(400, "Missing the required parameter 'shipping' when calling addShipping"));
    }

    // create path and map variables
    String path = "/shippings";
   ...
   * @param shipping Shipping to add to the store
  */
  public void addShipping (Shipping shipping, final Response.Listener<InlineResponse2013> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = shipping;
  ...
  * deletes a single shipping based on the ID supplied
   ...
   * @return void
  */
  public void deleteShippingById (Long id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling deleteShippingById",
        new ApiException(400, "Missing the required parameter 'id' when calling deleteShippingById"));
    }

    // create path and map variables
    String path = "/shippings/{id}/".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
   ...
   * @param id ID of shipping to delete
  */
  public void deleteShippingById (Long id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/shippings/{id}/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  * Returns a shipping based on a single ID
   ...
   * @return InlineResponse2013
  */
  public InlineResponse2013 getShippingById (Long id, Integer limit) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getShippingById",
        new ApiException(400, "Missing the required parameter 'id' when calling getShippingById"));
    }
   ...
   * 
   * Returns a shipping based on a single ID
   * @param id ID of shipping to fetch   * @param limit max records to return
  */
  public void getShippingById (Long id, Integer limit, final Response.Listener<InlineResponse2013> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns all shippings from the system that the user has access to
   * @param includes Include associated objects within response
   * @param limit max records to return
   * @param orderBy Specify the field to be sorted, examples:  - &#x60;?order_by&#x3D;id|desc&#x60; - &#x60;?order_by&#x3D;updated_at|desc,position|asc&#x60; 
   * @return InlineResponse2003
  */
  public InlineResponse2003 getShippings (List<String> includes, Integer limit, List<String> orderBy) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    // form params
    Map<String, String> formParams = new HashMap<String, String>();
    queryParams.addAll(ApiInvoker.parameterToPairs("csv", "includes", includes));
    queryParams.addAll(ApiInvoker.parameterToPairs("", "limit", limit));
    queryParams.addAll(ApiInvoker.parameterToPairs("multi", "order_by", orderBy));
    String[] contentTypes = {
      "application/json"
    };
    String contentType = contentTypes.length > 0 ? contentTypes[0] : "application/json";
   ...
   * 
   * Returns all shippings from the system that the user has access to
   * @param includes Include associated objects within response   * @param limit max records to return   * @param orderBy Specify the field to be sorted, examples:  - &#x60;?order_by&#x3D;id|desc&#x60; - &#x60;?order_by&#x3D;updated_at|desc,position|asc&#x60; 
  */
  public void getShippings (List<String> includes, Integer limit, List<String> orderBy, final Response.Listener<InlineResponse2003> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * update a single shipping based on the ID supplied
   ...
   * @return InlineResponse2013
  */
  public InlineResponse2013 updateShippingById (Long id, Shipping tax) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tax;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateShippingById",
        new ApiException(400, "Missing the required parameter 'id' when calling updateShippingById"));
    }
    // verify the required parameter 'tax' is set
    if (tax == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tax' when calling updateShippingById",
        new ApiException(400, "Missing the required parameter 'tax' when calling updateShippingById"));
    }
   ...
   * 
   * update a single shipping based on the ID supplied
   * @param id ID of shipping to update   * @param tax Shipping to update in store
  */
  public void updateShippingById (Long id, Shipping tax, final Response.Listener<InlineResponse2013> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tax;
  ...
  * update a single shipping based on the ID supplied
   ...
   * @return InlineResponse2013
  */
  public InlineResponse2013 updateShippingById_1 (Long id, Shipping tax) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tax;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateShippingById_1",
        new ApiException(400, "Missing the required parameter 'id' when calling updateShippingById_1"));
    }
    // verify the required parameter 'tax' is set
    if (tax == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tax' when calling updateShippingById_1",
        new ApiException(400, "Missing the required parameter 'tax' when calling updateShippingById_1"));
    }
   ...
   * @param id ID of shipping to update   * @param tax Shipping to update in store
  */
  public void updateShippingById_1 (Long id, Shipping tax, final Response.Listener<InlineResponse2013> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tax;
