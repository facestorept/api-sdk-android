...
public class TaxesApi {
  ...
  */
  public InlineResponse2012 addTaxes (Tax tax) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tax;
    // verify the required parameter 'tax' is set
    if (tax == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tax' when calling addTaxes",
        new ApiException(400, "Missing the required parameter 'tax' when calling addTaxes"));
    }
   ...
   * @param tax Tax to add to the store
  */
  public void addTaxes (Tax tax, final Response.Listener<InlineResponse2012> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tax;
    ...
    // create path and map variables
    String path = "/taxes".replaceAll("\\{format\\}","json");
  ...
  * deletes a single tax based on the ID supplied
   ...
   * @return void
  */
  public void deleteTaxById (Long id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling deleteTaxById",
        new ApiException(400, "Missing the required parameter 'id' when calling deleteTaxById"));
    }

    // create path and map variables
    String path = "/taxes/{id}/".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
   ...
   * @param id ID of tax to delete
  */
  public void deleteTaxById (Long id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/taxes/{id}/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  * Returns a tax based on a single ID
   ...
   * @return InlineResponse2012
  */
  public InlineResponse2012 getTaxById (Long id, Integer limit) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getTaxById",
        new ApiException(400, "Missing the required parameter 'id' when calling getTaxById"));
    }
   ...
   * 
   * Returns a tax based on a single ID
   * @param id ID of tax to fetch   * @param limit max records to return
  */
  public void getTaxById (Long id, Integer limit, final Response.Listener<InlineResponse2012> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public InlineResponse2002 getTaxes (List<String> includes, Integer limit, List<String> orderBy) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getTaxes (List<String> includes, Integer limit, List<String> orderBy, final Response.Listener<InlineResponse2002> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * update a single tax based on the ID supplied
   ...
   * @return InlineResponse2012
  */
  public InlineResponse2012 updateTaxById (Long id, Tax tax) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tax;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateTaxById",
        new ApiException(400, "Missing the required parameter 'id' when calling updateTaxById"));
    }
    // verify the required parameter 'tax' is set
    if (tax == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tax' when calling updateTaxById",
        new ApiException(400, "Missing the required parameter 'tax' when calling updateTaxById"));
    }
   ...
   * 
   * update a single tax based on the ID supplied
   * @param id ID of tax to update   * @param tax Tax to add to the store
  */
  public void updateTaxById (Long id, Tax tax, final Response.Listener<InlineResponse2012> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tax;
  ...
  * update a single tax based on the ID supplied
   ...
   * @return InlineResponse2012
  */
  public InlineResponse2012 updateTaxById_1 (Long id, Tax tax) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tax;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateTaxById_1",
        new ApiException(400, "Missing the required parameter 'id' when calling updateTaxById_1"));
    }
    // verify the required parameter 'tax' is set
    if (tax == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tax' when calling updateTaxById_1",
        new ApiException(400, "Missing the required parameter 'tax' when calling updateTaxById_1"));
    }
   ...
   * @param id ID of tax to update   * @param tax Tax to add to the store
  */
  public void updateTaxById_1 (Long id, Tax tax, final Response.Listener<InlineResponse2012> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tax;
