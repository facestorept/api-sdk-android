...
public class BrandsApi {
  ...
  */
  public InlineResponse201 addBrands (Brand brand) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = brand;
    // verify the required parameter 'brand' is set
    if (brand == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'brand' when calling addBrands",
        new ApiException(400, "Missing the required parameter 'brand' when calling addBrands"));
    }
   ...
   * @param brand Brand to add to the store
  */
  public void addBrands (Brand brand, final Response.Listener<InlineResponse201> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = brand;
  ...
  * Deletes a single brand based on the ID supplied
   ...
   * @return void
  */
  public void deleteBrandById (Long id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling deleteBrandById",
        new ApiException(400, "Missing the required parameter 'id' when calling deleteBrandById"));
    }

    // create path and map variables
    String path = "/brands/{id}/".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
   ...
   * @param id ID of brand to delete
  */
  public void deleteBrandById (Long id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/brands/{id}/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  * Returns a brand based on a single ID  ### Includes You can give the following values on includea parameter: &#x60;routes, products&#x60; 
   ...
   * @return InlineResponse201
  */
  public InlineResponse201 getBrandById (Long id, List<String> includes, Integer limit) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
   ...
   * 
   * Returns a brand based on a single ID  ### Includes You can give the following values on includea parameter: &#x60;routes, products&#x60; 
   * @param id ID of brand to fetch   * @param includes Include associated objects within response   * @param limit max records to return
  */
  public void getBrandById (Long id, List<String> includes, Integer limit, final Response.Listener<InlineResponse201> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public InlineResponse200 getBrands (List<String> includes, Integer limit, List<String> orderBy) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getBrands (List<String> includes, Integer limit, List<String> orderBy, final Response.Listener<InlineResponse200> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Update a single brand based on the ID supplied
   ...
   * @return void
  */
  public void updateCategoryById (Long id, Object brand) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = brand;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateCategoryById",
        new ApiException(400, "Missing the required parameter 'id' when calling updateCategoryById"));
    }
    // verify the required parameter 'brand' is set
    if (brand == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'brand' when calling updateCategoryById",
        new ApiException(400, "Missing the required parameter 'brand' when calling updateCategoryById"));
    }
   ...
   * 
   * Update a single brand based on the ID supplied
   * @param id ID of brand to update   * @param brand Brand to update in store
  */
  public void updateCategoryById (Long id, Object brand, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = brand;
  ...
  * Update a single brand based on the ID supplied
   ...
   * @return void
  */
  public void updateCategoryById_1 (Long id, Object brand) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = brand;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateCategoryById_1",
        new ApiException(400, "Missing the required parameter 'id' when calling updateCategoryById_1"));
    }
    // verify the required parameter 'brand' is set
    if (brand == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'brand' when calling updateCategoryById_1",
        new ApiException(400, "Missing the required parameter 'brand' when calling updateCategoryById_1"));
    }
   ...
   * @param id ID of brand to update   * @param brand Brand to update in store
  */
  public void updateCategoryById_1 (Long id, Object brand, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = brand;
