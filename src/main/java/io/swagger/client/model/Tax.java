...
public class Tax {
  ...
  public boolean equals(Object o) {
    ...
    Tax tax = (Tax) o;
    return (this.id == null ? tax.id == null : this.id.equals(tax.id)) &&
        (this.name == null ? tax.name == null : this.name.equals(tax.name)) &&
        (this.isDefault == null ? tax.isDefault == null : this.isDefault.equals(tax.isDefault)) &&
        (this.active == null ? tax.active == null : this.active.equals(tax.active)) &&
        (this.createdAt == null ? tax.createdAt == null : this.createdAt.equals(tax.createdAt)) &&
        (this.updatedAt == null ? tax.updatedAt == null : this.updatedAt.equals(tax.updatedAt));
  }
