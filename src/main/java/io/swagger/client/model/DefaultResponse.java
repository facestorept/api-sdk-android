...
public class DefaultResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.code == null ? defaultResponse.code == null : this.code.equals(defaultResponse.code)) &&
        (this.type == null ? defaultResponse.type == null : this.type.equals(defaultResponse.type)) &&
        (this.message == null ? defaultResponse.message == null : this.message.equals(defaultResponse.message));
  }
