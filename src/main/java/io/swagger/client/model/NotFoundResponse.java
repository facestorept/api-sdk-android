...
public class NotFoundResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.code == null ? notFoundResponse.code == null : this.code.equals(notFoundResponse.code)) &&
        (this.message == null ? notFoundResponse.message == null : this.message.equals(notFoundResponse.message));
  }
