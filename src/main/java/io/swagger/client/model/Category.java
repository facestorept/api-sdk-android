...
public class Category {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? category.id == null : this.id.equals(category.id)) &&
        (this.position == null ? category.position == null : this.position.equals(category.position)) &&
        (this.imageSmall == null ? category.imageSmall == null : this.imageSmall.equals(category.imageSmall)) &&
        (this.imageLarger == null ? category.imageLarger == null : this.imageLarger.equals(category.imageLarger)) &&
        ...
        (this.updatedAt == null ? category.updatedAt == null : this.updatedAt.equals(category.updatedAt)) &&
        (this.visibility == null ? category.visibility == null : this.visibility.equals(category.visibility)) &&
        (this.i18n == null ? category.i18n == null : this.i18n.equals(category.i18n));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.imageSmall == null ? 0: this.imageSmall.hashCode());
    result = 31 * result + (this.imageLarger == null ? 0: this.imageLarger.hashCode());
