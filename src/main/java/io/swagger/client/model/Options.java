...
public class Options {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? options.id == null : this.id.equals(options.id)) &&
        (this.position == null ? options.position == null : this.position.equals(options.position)) &&
        (this.auxCode == null ? options.auxCode == null : this.auxCode.equals(options.auxCode)) &&
        (this.i18n == null ? options.i18n == null : this.i18n.equals(options.i18n)) &&
        (this.createdAt == null ? options.createdAt == null : this.createdAt.equals(options.createdAt)) &&
        (this.updatedAt == null ? options.updatedAt == null : this.updatedAt.equals(options.updatedAt));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.auxCode == null ? 0: this.auxCode.hashCode());
