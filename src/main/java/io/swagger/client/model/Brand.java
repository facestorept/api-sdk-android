...
public class Brand {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? brand.id == null : this.id.equals(brand.id)) &&
        (this.position == null ? brand.position == null : this.position.equals(brand.position)) &&
        (this.imageSmall == null ? brand.imageSmall == null : this.imageSmall.equals(brand.imageSmall)) &&
        (this.imageLarger == null ? brand.imageLarger == null : this.imageLarger.equals(brand.imageLarger)) &&
        ...
        (this.visibility == null ? brand.visibility == null : this.visibility.equals(brand.visibility)) &&
        (this.i18n == null ? brand.i18n == null : this.i18n.equals(brand.i18n));
  }
