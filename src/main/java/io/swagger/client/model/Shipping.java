...
public class Shipping {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? shipping.id == null : this.id.equals(shipping.id)) &&
        (this.name == null ? shipping.name == null : this.name.equals(shipping.name)) &&
        (this.image == null ? shipping.image == null : this.image.equals(shipping.image)) &&
        (this.active == null ? shipping.active == null : this.active.equals(shipping.active)) &&
        (this.createdAt == null ? shipping.createdAt == null : this.createdAt.equals(shipping.createdAt)) &&
        (this.updatedAt == null ? shipping.updatedAt == null : this.updatedAt.equals(shipping.updatedAt));
  }
