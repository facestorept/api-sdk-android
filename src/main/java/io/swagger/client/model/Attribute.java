...
public class Attribute {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? attribute.id == null : this.id.equals(attribute.id)) &&
        (this.position == null ? attribute.position == null : this.position.equals(attribute.position)) &&
        (this.isSearchable == null ? attribute.isSearchable == null : this.isSearchable.equals(attribute.isSearchable)) &&
        (this.active == null ? attribute.active == null : this.active.equals(attribute.active)) &&
        (this.options == null ? attribute.options == null : this.options.equals(attribute.options)) &&
        (this.i18n == null ? attribute.i18n == null : this.i18n.equals(attribute.i18n)) &&
        (this.createdAt == null ? attribute.createdAt == null : this.createdAt.equals(attribute.createdAt)) &&
        (this.updatedAt == null ? attribute.updatedAt == null : this.updatedAt.equals(attribute.updatedAt));
  }
