...
public class Payment {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? payment.id == null : this.id.equals(payment.id)) &&
        (this.name == null ? payment.name == null : this.name.equals(payment.name)) &&
        (this.active == null ? payment.active == null : this.active.equals(payment.active)) &&
        (this.createdAt == null ? payment.createdAt == null : this.createdAt.equals(payment.createdAt)) &&
        (this.updatedAt == null ? payment.updatedAt == null : this.updatedAt.equals(payment.updatedAt));
  }
