...
public class MetaPartialResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.firstPageUrl == null ? metaPartialResponse.firstPageUrl == null : this.firstPageUrl.equals(metaPartialResponse.firstPageUrl)) &&
        (this.lastPageUrl == null ? metaPartialResponse.lastPageUrl == null : this.lastPageUrl.equals(metaPartialResponse.lastPageUrl)) &&
        (this.nextPageUrl == null ? metaPartialResponse.nextPageUrl == null : this.nextPageUrl.equals(metaPartialResponse.nextPageUrl)) &&
        (this.path == null ? metaPartialResponse.path == null : this.path.equals(metaPartialResponse.path)) &&
        (this.prevPageUrl == null ? metaPartialResponse.prevPageUrl == null : this.prevPageUrl.equals(metaPartialResponse.prevPageUrl));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.firstPageUrl == null ? 0: this.firstPageUrl.hashCode());
    result = 31 * result + (this.lastPageUrl == null ? 0: this.lastPageUrl.hashCode());
    result = 31 * result + (this.nextPageUrl == null ? 0: this.nextPageUrl.hashCode());
    result = 31 * result + (this.path == null ? 0: this.path.hashCode());
    result = 31 * result + (this.prevPageUrl == null ? 0: this.prevPageUrl.hashCode());
    return result;
  }
